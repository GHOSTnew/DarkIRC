...
public class DccChat {
        ...
        /**
         * This constructor is used when we are accepting a DCC CHAT request from somebody. It
         * attempts to connect to the client that issued the request.
         * 
        ...
        /**
         * This constructor is used after we have issued a DCC CHAT request to somebody. If the
         * client accepts the chat request, then the socket we obtain is passed to this constructor.
         * 
         * @param bot An instance of the underlying PircBot.
         ...
         * This method blocks until something can be returned. If the connection has closed, null is
         * returned.
         * 
         ...
         * 
         * @param line The line of text to be sent. This should not include linefeed characters.
         * 
         * @throws IOException If an I/O error occurs.
         */

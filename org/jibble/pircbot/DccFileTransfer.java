...
public class DccFileTransfer {
        ...
        /**
         * Receives a DccFileTransfer and writes it to the specified file. Resuming allows a partial
         * download to be continue from the end of the current file contents.
         * 
         * @param file The file to write to.
         * @param resume True if you wish to try and resume the download instead of overwriting an
         *        existing file.
         * 
         */
        ...
        /**
         * Sets the delay time between sending or receiving each packet. Default is 0. This is
         * useful for throttling the speed of file transfers to maintain a good quality of service
         * for other things on the machine or network.
         * 
        ...
        /**
         * Returns the progress (in bytes) of the current file transfer. When resuming, this
         * represents the total number of bytes in the file, which may be greater than the amount of
         * bytes resumed in just this transfer.
         * 
        ...
        /**
         * Returns the progress of the file transfer as a percentage. Note that this should never be
         * negative, but could become greater than 100% if you attempt to resume a larger file onto
         * a partially downloaded file that was smaller.
         * 
        ...
        /**
         * Returns the rate of data transfer in bytes per second. This value is an estimate based on
         * the number of bytes transfered since the connection was established.
         * 
